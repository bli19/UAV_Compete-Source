//I change the frequency to  50 hz and make 1ms (THR OFF) and 1.2 ms (THR ON) pulse at different port. 
//Do not connect the Red wire from ESC, just connect the white and black wire, white wire is the signaling
//wire. Goes to the PWM output PC6 or P7C 
/**
  ******************************************************************************
...
uint16_t CCR3_Val = 100-1;
uint16_t CCR4_Val = 100-1;
